    ...
    <div class="container">
      ...
      <aplayer
        :music="{
          title: '(Maria)',
          artist: '华莎',
          src: 'http://antiserver.kuwo.cn/anti.s?useless=/resource/&format=mp3&rid=MUSIC_145557417&response=res&type=convert_url',
          pic: 'http://y.qq.com/music/photo_new/T001R150x150M000001HBhty3s7aog.jpg?max_age=2592000'
        }"
      />
